    ...
    if (detectionMode === "face" && faceFile) {
      ...
      axios
        ...
        .then((response) => {
          ...
          // For demo purposes - create mock result from the response
          const mockEmotions = ["Happy", "Sad", "Angry", "Neutral", "Fear", "Surprise"];
          const selectedEmotion = mockEmotions[Math.floor(Math.random() * mockEmotions.length)];
          ...
          {detectionMode === "face" ? (
            ...
            <div className="flex flex-col items-center space-y-4">
              {!audioFileName ? (
                ...
                <div className="w-full">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-medium text-gray-900">Selected Audio</h3>
                    <button
                      type="button"
                      onClick={handleReset}
                      className="text-sm font-medium text-blue-600 hover:text-blue-500"
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg mb-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">{audioFileName}</p>
