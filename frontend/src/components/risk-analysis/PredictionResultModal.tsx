...
export default function PredictionResultModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg max-w-md w-full mx-3 overflow-hidden">
        {/* Header */}
        ...
        <div className="p-4">
          ...
          <div 
            className={`rounded-lg p-3 mb-4 ${
              isNegative ? "bg-green-50 border border-green-100" : "bg-red-50 border border-red-100"
            }`}
          >
            <div className="flex items-center gap-3">
              ...
              <p className={`text-sm font-medium ${isNegative ? "text-green-700" : "text-red-700"}`}>
                {isNegative
          ...
          <div className="flex justify-center gap-4 mb-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm font-medium mt-1 px-3 py-0.5 rounded-full bg-blue-100 text-blue-700">
                {result.Confidence}%
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 rounded-lg border border-gray-200 p-3 bg-gray-50 text-sm">
            ...
            <div className="space-y-3">
              <div className="bg-white rounded p-2.5 border-l-3 border-yellow-400 shadow-sm">
                <p className="font-medium text-gray-700 text-xs mb-1">Risk Level: 50 - 75%</p>
              ...
              <div className="bg-white rounded p-2.5 border-l-3 border-red-400 shadow-sm">
                <p className="font-medium text-gray-700 text-xs mb-1">Risk Level: 75% - 100%</p>
                <p className="text-gray-600 text-xs mb-2">
                  We highly recommend scheduling an MRI scan for a more accurate
                  diagnosis. You can also try our MRI prediction tool for further insights.
                </p>
                <Button
                  onClick={() => {
                    console.log("Memory therapy button clicked");
